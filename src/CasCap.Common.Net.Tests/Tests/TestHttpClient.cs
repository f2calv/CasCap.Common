...
{
    /// <summary>
    /// Sets the <see cref="HttpClient"/> and <see cref="ILogger"/> dependencies for testing.
    /// </summary>
    ...
    /// <summary>
    /// Exposes <see cref="HttpClientBase.PostJsonAsync{TResult, TError}"/> for testing.
    /// </summary>
    ...
    /// <summary>
    /// Exposes <see cref="HttpClientBase.PostJson{TResult, TError}"/> for testing.
    /// </summary>
    ...
    /// <summary>
    /// Exposes <see cref="HttpClientBase.PostBytesAsync{TResult, TError}"/> for testing.
    /// </summary>
    ...
    /// <summary>
    /// Exposes <see cref="HttpClientBase.GetAsync{TResult, TError}"/> for testing.
    /// </summary>
    ...
    /// <summary>
    /// Exposes <see cref="HttpClientBase.Get{TResult, TError}"/> for testing.
    /// </summary>
