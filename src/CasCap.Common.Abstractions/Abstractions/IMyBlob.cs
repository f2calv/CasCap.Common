...
/// <summary>Represents a blob with associated metadata.</summary>
public interface IMyBlob
{
    ...
    /// <summary>The generated file name for the blob.</summary>
    public string BlobName { get; init; }

    /// <summary>The size of the blob in bytes.</summary>
    public int SizeInBytes { get; }

    /// <summary>Indicates whether the blob contains any data.</summary>
