...
public record CacheOptions
{
    ...
    /// <summary>
    /// The Redis database index to use for the remote cache.
    /// </summary>
    public int DatabaseId { get; init; } = 0;

    /// <summary>
    /// Whether to clear all cached items when the service starts.
    /// </summary>
    public bool ClearOnStartup { get; init; } = false;

    /// <summary>
    /// The serialization format used for cache entries in this layer.
    /// </summary>
