...
/// <summary>Test class for verifying serialization round-trip behaviour.</summary>
...
public class MyTestClass
{
    ...
    /// <summary>UTC <see cref="DateTime"/> test value.</summary>
    public DateTime utcNow { get; set; } = DateTime.UtcNow;

    /// <summary>Local date test value.</summary>
    public DateTime dtNow { get; set; } = DateTime.Now.Date;

    DateTime _dtNowFixed;

    /// <summary>We send in a normal datetime, which when deserialized by MessagePack gets converted to Utc.</summary>
    ...
    /// <summary>Dictionary of <see cref="DateTime"/> to string values for round-trip testing.</summary>
